        ...
        <el-menu>
          <el-menu-item index="1">
             ...
             <i class="el-icon-user"></i>
              <span @click="project1" slot="title">重大课题</span>
          </li>
          </el-menu-item>
           <el-menu-item index="2">
              <li class="left-nav">
             <i class="el-icon-user"></i>
              <span @click="project2" slot="title">国家级课题</span>
          </li>
          </el-menu-item>
           <el-menu-item index="3">
              <li class="left-nav">
             <i class="el-icon-user"></i>
              <span @click="project3" slot="title">省部级课题</span>
          </li>
          </el-menu-item>
           <el-menu-item index="3">
              <li class="left-nav">
             <i class="el-icon-user"></i>
              <span @click="project4" slot="title">横向课题</span>
          </li>
          </el-menu-item>
        </el-menu>
